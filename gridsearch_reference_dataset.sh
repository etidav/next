...
# electricity
python3 /next/run/reference_dataset/run_gridsearch_NEXT_model.py --main_folder /next/result/traffic_gridsearch --dataset_path /next/data/reference_dataset/electricity/electricity.csv --past_dependency_list 168 336 504 672 --season 168 --horizon 96 --nb_max_epoch 50 --nb_iteration_per_epoch 50 --learning_rate_list 0.005 --batch_size_list 2048 --gpu_number 0 --seed 0
