...
from model.NEXT_model import next_model_no_ext_signal, next_model_no_ext_signal_FC, next_model_no_ext_signal_full_FC
...
if __name__ == "__main__":
    ...
    model = next_model_no_ext_signal_full_FC(
